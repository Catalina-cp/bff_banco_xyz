...
/**
 * Filtro de autenticacion por API Key para el canal Web.
 *
 ...
 * peticion con el rol ROLE_WEB. Si no coincide o falta, la peticion sigue
 * sin autenticar y Spring Security la rechaza mas adelante (401/403).
 */
@Component
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (apiKeyValida.equals(apiKeyRecibida)) {
            var authentication = new UsernamePasswordAuthenticationToken(
                    "canal-web",
                    null,
                    List.of(new SimpleGrantedAuthority("ROLE_WEB"))
            );
